...
const recentActions = [
  { text: 'Derek 提交了入社申请', time: '2 小时前' },
  { text: '白开水 创建了活动「电影夜 · 花样年华」', time: '5 小时前' },
  { text: '星星 投票了 3 部电影', time: '1 天前' },
  { text: '社区通讯 #12 已发送（28 人）', time: '2 天前' },
  { text: 'Tiffy 被批准为 Host', time: '3 天前' },
  { text: '奶茶 提交了入社申请', time: '4 天前' },
  { text: '阿德 创建了活动「录音棚体验日」', time: '5 天前' },
  { text: '社区公约 v2.0 发布', time: '1 周前' },
];
...
export default function AdminDashboardPage() {
  ...
  const activityStats = stats
    ? [
        ...
        { label: '活跃 Host', value: String(stats.activeHosts), sub: '本月' },
  ...
  const memberActivity = stats
    ? [
        ...
        { label: '本月 Host', value: `${stats.activeHosts} 人` },
