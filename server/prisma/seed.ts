...
async function seedEmailRulesAndTemplates() {
  ...
  const templates: { ruleId: string; variantKey: string; subject: string; body: string }[] = [
    ...
    },
    {
      ruleId: 'TXN-7',
      variantKey: 'default',
      subject: '【串门儿】{fromName} 给你寄了一张感谢卡 💌',
      body: '你好 {toName}，\n\n{fromName} 给你寄了一张感谢卡 💌',
    },
    {
      ruleId: 'P0-A',
      variantKey: 'default',
      subject: '【串门儿】{hostName} 喊你来「{eventTitle}」',
      body: '你好 {userName}，\n\n{hostName} 组了个局——「{eventTitle}」，想叫你一起来！\n\n时间：{eventDate}\n地点：{eventLocation}\n\n感兴趣的话赶紧报名呀～',
    },
    {
      ruleId: 'P0-B',
      variantKey: 'default',
      subject: '【串门儿】明天见！「{eventTitle}」',
      body: '你好 {userName}，\n\n提醒一下，你报名的「{eventTitle}」明天就开始啦！\n\n时间：{eventDate}\n地点：{eventLocation}\n\n记得来哦，大家都等着你呢 👋',
    },
    {
      ruleId: 'P3-F',
      variantKey: 'default',
      subject: '【串门儿】{userName}，好久不见！',
      body: '你好 {userName}，\n\n好久没在串门儿看到你了，最近忙什么呢？\n\n社区最近有不少新活动和新朋友，有空来看看吧。大家都挺想你的 😊',
    },
    {
      ruleId: 'P3-D',
      variantKey: 'default',
      subject: '【串门儿】{userName}，要不你也来组个局？',
      body: '你好 {userName}，\n\n你已经参加了好几次串门儿的活动了，大家都挺喜欢跟你玩的！\n\n有没有想过自己组一次？真的不用很复杂——在家看个电影、叫大家来吃顿饭、一起出去走走，都很棒。\n\n我们会帮你搞定发布和报名的事，你就负责开心就好 😄',
    },
    {
      ruleId: 'P3-E',
      variantKey: 'default',
      subject: '【串门儿】{userName}，大家想念你组的局了',
